...
class GymManager:
    ...
    def save_data(self):
        try:
            self.promo_details.to_csv('promo_details.csv', index=False)
            self.member_details.to_csv('member_details.csv', index=False)
            self.member_transaction.to_csv('member_transaction.csv', index=False)
            self.gym_revenue.to_csv('gym_revenue.csv', index=False)
